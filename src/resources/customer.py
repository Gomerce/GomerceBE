...
class CustomerResource(Resource):
    ...
    def update_customer(customer_id, username, last_name, first_name, email,
                        phone, country, state, city, street_name, zipcode):
        """ Update a customer based on the provided information """

        customer = CustomerRepository()
        customer = customer.update(
            customer_id=customer_id, sername=username, first_name=first_name,
            last_name=last_name, email=email, phone=phone, country=country,
            state=state, city=city, street_name=street_name, zipcode=zipcode
        )
